...
starter.setup({
  ...
  items = {
    ...
    { action = "lua require('snacks').picker.files()", name = "Find files", section = "File Picker" },
    { action = "lua require('snacks').picker.recent()", name = "Recent files", section = "File Picker" },
